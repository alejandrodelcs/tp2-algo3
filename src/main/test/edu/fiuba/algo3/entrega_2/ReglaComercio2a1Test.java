...
public class ReglaComercio2a1Test {
    @Test
    public void test01SiLaCantidadYElTipoSonCorrectosNoDeberiaLanzarExcepcion(){
    ...
    @Test
    public void test03SiElTipoEsCorrectoPeroLaCantidadNoLanzaExcepcion(){
        ReglaComercio regla = new ReglaComercio2a1(Ladrillo.class);
        
        assertThrows(
                ComercioInvalido2a1.class, 
                () -> regla.validar(
                    List.of(Ladrillo.class), 
                    List.of(Madera.class)
                )
        );
    }
